...
def train_main(model, model_name, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        metrics_dict, dice, confmat = evaluate(model, val_loader, device, text_loss)
    ...
    val_metrics, val_dice, val_confmat = evaluate(model, val_loader, device, text_loss)
    test_metrics, test_dice, test_confmat = evaluate(model, test_loader, device, text_loss, header='Test:')
